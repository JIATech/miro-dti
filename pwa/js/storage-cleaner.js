...
class StorageCleaner {
        ...
        try {
            if (navigator.storage && navigator.storage.estimate) {
                ...
                if (this.storageMetrics.percentUsed > 80) {
                    console.warn('Almacenamiento crítico: ' + this.storageMetrics.percentUsed.toFixed(2) + '%');
    ...
    async cleanData(policy) {
        ...
        try {
            ...
            results.aggregatedMetricsRemoved = await this.cleanAggregatedMetrics(policy.aggregatedMetrics);
