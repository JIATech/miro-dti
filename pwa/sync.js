...
const IntercomSync = (function() {
    ...
    async function loadConfig() {
        try {
            ...
            IntercomDB.addErrorEntry('syncConfig', 'Error al cargar configuración', { error: error.message });
        }
    }
    ...
    async function saveConfig() {
        try {
            ...
            IntercomDB.addErrorEntry('syncConfig', 'Error al guardar configuración', { error: error.message });
        }
    }
